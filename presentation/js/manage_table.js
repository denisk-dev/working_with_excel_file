...
// console.log(objectId);
  ...
  ajaxRequestHandlerNoAction("DELETE", 'http://localhost:3000/students', objectId);
 
  document.getElementById('row' + number).outerHTML='';
  //need id to communicate with node
...
function addRow(){
  ...
  console.log(newInstanceObject);
  ajaxRequestHandlerNoAction("POST", 'http://localhost:3000/students', newInstanceObject);

  let table = document.getElementById('mainDataTable');
  let tableLength = table.rows.length - 1;
  var row = table.insertRow(tableLength).outerHTML="<tr id='row"+tableLength+"'><td id='RefDateRow"+tableLength+"'>"+newRefDate+"</td><td id='Georow"+tableLength+"'>"+newGeo+"</td>"+
  "<td id='Dguidrow"+tableLength+"'>"+newDguid+"</td>"+
  "<td id='Sexrow"+tableLength+"'>"+newSex+"</td>"+
  "<td id='AgeGrrow"+tableLength+"'>"+newAgeGr+"</td>"+
  "<td id='StudResrow"+tableLength+"'>"+newStudRes+"</td>"+
  "<td id='Uomrow"+tableLength+"'>"+newUom+"</td>"+
  "<td id='UomIdrow"+tableLength+"'>"+newUomId+"</td>"+
  "<td id='ScalFactrow"+tableLength+"'>"+newScalFact+"</td>"+
  "<td id='ScalIdrow"+tableLength+"'>"+newScalId+"</td>"+
  "<td id='Vectrow"+tableLength+"'>"+newVect+"</td>"+
  "<td id='Coorrow"+tableLength+"'>"+newCoor+"</td>"+
  "<td id='Valrow"+tableLength+"'>"+newVal+"</td>"+
  "<td id='Statrow"+tableLength+"'>"+newStat+"</td>"+
  "<td id='Symbrow"+tableLength+"'>"+newSymb+"</td>"+
  "<td id='Terminrow"+tableLength+"'>"+newTermin+"</td>"+
  "<td id='Decimrow"+tableLength+"'>"+newDecim+"</td>"+
  "<td><button type='button' id='buttonEdit"+tableLength+"' class='btn btn-warning' onclick='editRow("+tableLength+")'>Edit</button><button type='button' id='buttonSave"+tableLength+"' class='save btn btn-success' onclick='saveRow("+tableLength+")'>Save</button><button type='button' class='btn btn-danger' onclick='deleteRow("+tableLength+")'>Delete</button></td> </tr>";
...
ajaxRequestHandler('GET','http://localhost:3000/students', populateTableWithDataFromDB);


//Make sure it is reloading from the dataset and not mongodb
function reload(){
  location.reload();
  ajaxRequestHandlerNoAction('POST','http://localhost:3000/students/reload', {reload : true} );
  ajaxRequestHandler('GET','http://localhost:3000/students', populateTableWithDataFromDB);
}
...
function populateTableWithDataFromDB(data){
  ...
  //console.log(data[i].REF_DATE);
  console.log(data[2]);

  for(let i=0; i<data.length; i++){
    let table = document.getElementById('mainDataTable');
  let tableLength = table.rows.length - 1;
  var row = table.insertRow(tableLength).outerHTML="<tr id='row"+tableLength+"' class ='"+data[i]._id+"'><td id='RefDateRow"+tableLength+"'>"+data[i].REF_DATE+"</td><td id='Georow"+tableLength+"'>"+data[i].GEO+"</td>"+
  "<td id='Dguidrow"+tableLength+"'>"+data[i].DGUID+"</td>"+
  "<td id='Sexrow"+tableLength+"'>"+data[i].SEX+"</td>"+
  "<td id='AgeGrrow"+tableLength+"'>"+data[i].AGE_GROUP+"</td>"+
  "<td id='StudResrow"+tableLength+"'>"+data[i].STUDENT_RESPONSE+"</td>"+
  "<td id='Uomrow"+tableLength+"'>"+data[i].UOM+"</td>"+
  "<td id='UomIdrow"+tableLength+"'>"+data[i].UOM_ID+"</td>"+
  "<td id='ScalFactrow"+tableLength+"'>"+data[i].SCALAR_FACTOR+"</td>"+
  "<td id='ScalIdrow"+tableLength+"'>"+data[i].SCALAR_ID+"</td>"+
  "<td id='Vectrow"+tableLength+"'>"+data[i].VECTOR+"</td>"+
  "<td id='Coorrow"+tableLength+"'>"+data[i].COORDINATE+"</td>"+
  "<td id='Valrow"+tableLength+"'>"+data[i].VALUE+"</td>"+
  "<td id='Statrow"+tableLength+"'>"+data[i].STATUS+"</td>"+
  "<td id='Symbrow"+tableLength+"'>"+data[i].SYMBOL+"</td>"+
  "<td id='Terminrow"+tableLength+"'>"+data[i].TERMINATED+"</td>"+
  "<td id='Decimrow"+tableLength+"'>"+data[i].DECIMALS+"</td>"+
  "<td><button type='button' id='buttonEdit"+tableLength+"' class='btn btn-warning' onclick='editRow("+tableLength+")'>Edit</button><button type='button' id='buttonSave"+tableLength+"' class='save btn btn-success' onclick='saveRow("+tableLength+")'>Save</button><button type='button' class='btn btn-danger' onclick='deleteRow("+tableLength+")'>Delete</button></td> </tr>";
  }
}

//TODO add save button to addRow function
...
editRefDate.innerHTML="<input type='text' size='1' id='editedRefDate"+number+"' value='"+RefDate+"'>";
editGeo.innerHTML="<input type='text' size='1' id='editedGeo"+number+"' value='"+Geo+"'>"; 
editDguid.innerHTML="<input type='text' size='1' id='editedDguid"+number+"' value='"+Dguid+"'>"; 
editSex.innerHTML="<input type='text' size='1' id='editedSex"+number+"' value='"+Sex+"'>"; 
editAgeGr.innerHTML="<input type='text' size='1' id='editedAgeGr"+number+"' value='"+AgeGr+"'>"; 
editStudRes.innerHTML="<input type='text' size='1' id='editedStudRes"+number+"' value='"+StudRes+"'>"; 
editUom.innerHTML="<input type='text' size='1' id='editedUom"+number+"' value='"+Uom+"'>"; 
editUomId.innerHTML="<input type='text' size='1' id='editedUomId"+number+"' value='"+UomId+"'>"; 
editScalFact.innerHTML="<input type='text' size='1' id='editedScalFact"+number+"' value='"+ScalFact+"'>"; 
editScalId.innerHTML="<input type='text' size='1' id='editedScalId"+number+"' value='"+ScalId+"'>"; 
editVect.innerHTML="<input type='text' size='1' id='editedVect"+number+"' value='"+Vect+"'>"; 
editCoor.innerHTML="<input type='text' size='1' id='editedCoor"+number+"' value='"+Coor+"'>"; 
editVal.innerHTML="<input type='text' size='1' id='editedVal"+number+"' value='"+Val+"'>";
editStat.innerHTML="<input type='text' size='1' id='editedStat"+number+"' value='"+Stat+"'>"; 
editSymb.innerHTML="<input type='text' size='1' id='editedSymb"+number+"' value='"+Symb+"'>";
editTermin.innerHTML="<input type='text' size='1' id='editedTermin"+number+"' value='"+Termin+"'>";
editDecim.innerHTML="<input type='text' size='1' id='editedDecim"+number+"' value='"+Decim+"'>";
}
...
// TODO pass it to NODE
  console.log(newInstanceObject);

  ajaxRequestHandlerNoAction("PATCH", 'http://localhost:3000/students', newInstanceObject);
...
function downloadData(){
 ...
 ajaxRequestHandlerNoAction("POST", 'http://localhost:3000/students/download', allDataObject);
