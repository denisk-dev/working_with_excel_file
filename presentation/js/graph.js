...
function addGraph() {
  ...
  $("#displayBut").click(function () {
    ...
    let totalResponses =
      oftenRes + sometimesRes + alwaysRes + rarelyOrNeverRes + doNotRide;
    ...
    selectedData.push(
      ...
      {
        respone:
          "Sometimes (" + Math.round(sometimesRes / onePercentFromTotal) + "%)",
        amount: sometimesRes / onePercentFromTotal,
      },
      {
        respone:
          "Always (" + Math.round(alwaysRes / onePercentFromTotal) + "%)",
        amount: alwaysRes / onePercentFromTotal,
      },
      {
        respone:
          "Rarely or never (" +
          Math.round(rarelyOrNeverRes / onePercentFromTotal) +
          "%)",
      ...
      },
      {
        respone:
          ...
          Math.round(doNotRide / onePercentFromTotal) +
          "%)",
